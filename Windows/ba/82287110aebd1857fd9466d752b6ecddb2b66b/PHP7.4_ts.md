...
| - | - | - | - | - |
| 14970 | 10718 | 15660 | 4.4061% | 6.4378% |
...
```patch
001+ Wed Jun  9 02:42:17 2021 (3952): Fatal Error opcache.file_cache_only is set without a proper setting of opcache.file_cache
...
```patch
001+ Wed Jun  9 02:42:17 2021 (3952): Fatal Error opcache.file_cache_only is set without a proper setting of opcache.file_cache
001- Wed Jun  9 02:34:28 2021 (696): Fatal Error opcache.file_cache_only is set without a proper setting of opcache.file_cache
```
...
```patch
006+ Child 2520 didn't exit after 5000us
...
```patch
009+ Notice: fwrite(): Write of 37 bytes failed with errno=9 Bad file descriptor in D:\a\swow-bcreports\swow-bcreports\phpbc_expr_phpsrc_c218a339ed96cb46\ext\standard\tests\file\007_variation1.php on line 32
...
```patch
009+ Notice: fwrite(): Write of 37 bytes failed with errno=9 Bad file descriptor in D:\a\swow-bcreports\swow-bcreports\phpbc_expr_phpsrc_c218a339ed96cb46\ext\standard\tests\file\007_variation17.php on line 32
009- Notice: fwrite(): write of 37 bytes failed with errno=9 Bad file descriptor in %s on line %d
```
...
```patch
009+ Notice: fwrite(): Write of 37 bytes failed with errno=9 Bad file descriptor in D:\a\swow-bcreports\swow-bcreports\phpbc_expr_phpsrc_c218a339ed96cb46\ext\standard\tests\file\007_variation9.php on line 32
009- Notice: fwrite(): write of 37 bytes failed with errno=9 Bad file descriptor in %s on line %d
```
...
```patch
001+ Warning: stream_socket_client(): unable to connect to tcp://www.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.com:80 (Failed to parse address "invalid") in D:\a\swow-bcreports\swow-bcreports\phpbc_expr_phpsrc_c218a339ed96cb46\ext\standard\tests\network\bindto.php on line 9
...
```patch
001+ expected 'привет3', got ''
006- string(13) "привет4"
007- bool(true)
007+ string(0) ""
008+ bool(false)
```
