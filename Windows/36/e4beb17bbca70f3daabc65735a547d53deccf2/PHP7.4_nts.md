...
```patch
001+ Tue Jun  8 05:52:02 2021 (3168): Fatal Error opcache.file_cache_only is set without a proper setting of opcache.file_cache
...
```patch
001+ Tue Jun  8 05:52:02 2021 (3168): Fatal Error opcache.file_cache_only is set without a proper setting of opcache.file_cache
001- Tue Jun  8 05:43:00 2021 (1860): Fatal Error opcache.file_cache_only is set without a proper setting of opcache.file_cache
```
...
```patch
016+ Warning: opendir(foo/hi): failed to open dir: Unknown error in phar://D:/a/swow-bcreports/swow-bcreports/phpbc_expr_phpsrc_4a6f7374d62f6e90/ext/phar/tests/phar_gobyebye-win32.phar.php/foo/hi on line 7
...
```patch
006+ Child 3136 didn't exit after 5000us
...
```patch
001+ Warning: stream_socket_client(): unable to connect to tcp://www.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.com:80 (Failed to parse address "invalid") in D:\a\swow-bcreports\swow-bcreports\phpbc_expr_phpsrc_4a6f7374d62f6e90\ext\standard\tests\network\bindto.php on line 9
